...
**Primary Documentation:** [../runtime/SCHEDULER_ARCHITECTURE.md](../runtime/SCHEDULER_ARCHITECTURE.md) — Complete architecture and usage guide
...
- [OBSERVABILITY_RUNBOOK.md](OBSERVABILITY_RUNBOOK.md) — Monitor scheduler heartbeat and job timing
- [INCIDENT_RESPONSE.md](INCIDENT_RESPONSE.md) — Troubleshoot stuck scheduler
````
