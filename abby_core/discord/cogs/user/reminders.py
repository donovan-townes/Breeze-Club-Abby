...
class RemindMe(commands.Cog):
    ...
    async def remind_me(self, interaction: discord.Interaction, message: str):
        ...
        if view.value is None:
            await interaction.edit_original_response(content="Reminder cancelled.", view=None)
            return
        ...
        # Only send to text-based channels that support messages
        if interaction.channel and isinstance(interaction.channel, (discord.TextChannel, discord.Thread, discord.DMChannel)):
